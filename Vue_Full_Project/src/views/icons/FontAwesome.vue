            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br/>bathtub <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br/>s15 <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br/>thermometer <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-thermometer-0 fa-lg mt-4"></i>
                        <br/>thermometer-0 <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-thermometer-1 fa-lg mt-4"></i>
                        <br/>thermometer-1 <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-thermometer-2 fa-lg mt-4"></i>
                        <br/>thermometer-2 <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-thermometer-3 fa-lg mt-4"></i>
                        <br/>thermometer-3 <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-thermometer-4 fa-lg mt-4"></i>
                        <br/>thermometer-4 <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br/>vcard <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-vcard-o fa-lg mt-4"></i>
                        <br/>vcard-o <span class="text-muted">(alias)</span>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>automobile <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>bank <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>bar-chart-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>battery-0 <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-battery-1 fa-lg mt-4"></i>
                        <br>battery-1 <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-battery-2 fa-lg mt-4"></i>
                        <br>battery-2 <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-battery-3 fa-lg mt-4"></i>
                        <br>battery-3 <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-battery-4 fa-lg mt-4"></i>
                        <br>battery-4 <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>cab <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>close <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>dashboard <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>edit <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>feed <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>file-movie-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>file-photo-o <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-file-picture-o fa-lg mt-4"></i>
                        <br>file-picture-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>file-sound-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>file-zip-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>flash <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>gear <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-gears fa-lg mt-4"></i>
                        <br>gears <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>group <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-hand-grab-o fa-lg mt-4"></i>
                        <br>hand-grab-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>hand-stop-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>hotel <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>hourglass-1 <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-hourglass-2 fa-lg mt-4"></i>
                        <br>hourglass-2 <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-hourglass-3 fa-lg mt-4"></i>
                        <br>hourglass-3 <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>image <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>institution <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>legal <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>life-bouy <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-life-buoy fa-lg mt-4"></i>
                        <br>life-buoy <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>life-saver <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>mail-forward <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-mail-reply fa-lg mt-4"></i>
                        <br>mail-reply <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-mail-reply-all fa-lg mt-4"></i>
                        <br>mail-reply-all <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>mobile-phone <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>mortar-board <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>navicon <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>photo <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>remove <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-reorder fa-lg mt-4"></i>
                        <br>reorder <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>send <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-send-o fa-lg mt-4"></i>
                        <br>send-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>soccer-ball-o <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>sort-down <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>sort-up <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>star-half-full <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>support <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>toggle-down <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-toggle-left fa-lg mt-4"></i>
                        <br>toggle-left <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>toggle-right <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-toggle-up fa-lg mt-4"></i>
                        <br>toggle-up <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>tv <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>unsorted <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>warning <span class="text-muted">(alias)</span>
                    </div>
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>intersex <span class="text-muted">(alias)</span>
                    </div>
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>bitcoin <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>cny <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-dollar fa-lg mt-4"></i>
                        <br>dollar <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>euro <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>rmb <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-rouble fa-lg mt-4"></i>
                        <br>rouble <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>ruble <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-rupee fa-lg mt-4"></i>
                        <br>rupee <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-shekel fa-lg mt-4"></i>
                        <br>shekel <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-sheqel fa-lg mt-4"></i>
                        <br>sheqel <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>turkish-lira <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>won <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-yen fa-lg mt-4"></i>
                        <br>yen <span class="text-muted">(alias)</span>
                    </div>
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>chain <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>copy <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-cut fa-lg mt-4"></i>
                        <br>cut <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-dedent fa-lg mt-4"></i>
                        <br>dedent <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>paste <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>rotate-left <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-rotate-right fa-lg mt-4"></i>
                        <br>rotate-right <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-save fa-lg mt-4"></i>
                        <br>save <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>unlink <span class="text-muted">(alias)</span>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>facebook-f <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>ge <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>gittip <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>ra <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>wechat <span class="text-muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <br>yc <span class="text-muted">(alias)</span>
                    </div>

                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i class="fa fa-yc-square fa-lg mt-4"></i>
                        <br>yc-square <span class="text-muted">(alias)</span>
                    </div>
