                            ...
                            <CardBlock className="card-body">
                                <Form action="" method="post" className="form-horizontal">
                                    <FormGroup row>
                                        ...
                                        <Col sm="6">
                                            <Input size="sm" type="text" id="input-small" name="input-small" className="input-sm" placeholder=".form-control-sm" />
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                        <Col sm="5">
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col sm="6">
                                            <Input size="lg" type="text" id="input-large" name="input-large" className="input-lg" placeholder=".form-control-lg" />
                                        </Col>
                                    </FormGroup>
                                </Form>
                            </CardBlock>
                            ...
                            <CardBlock className="card-body">
                                <Form action="" method="post" className="form-horizontal">
                                    <FormGroup row>
                                        <Col md="12">
                                            <InputGroup>
                                                <InputGroupAddon><i className="fa fa-user"></i>
                                                </InputGroupAddon>
                                    ...
                                    <FormGroup row>
                                        <Col md="12">
                                            <InputGroup>
                                                ...
                                                <InputGroupAddon><i className="fa fa-envelope-o"></i>
                                                </InputGroupAddon>
                                            </InputGroup>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                        <Col md="12">
                                            <InputGroup>
                                                <InputGroupAddon><i className="fa fa-euro"></i>
                                                </InputGroupAddon>
                                ...
                                <Form action="" method="post" className="form-horizontal">
                                    ...
                                    <FormGroup row>
                                        <Col md="12">
                                            <InputGroup>
                                                <InputGroupButton>
                                                    <Button color="primary"><i className="fa fa-facebook"></i>
                                                    </Button>
                                                </InputGroupButton>
                                                <Input type="text" id="input3-group2" name="input3-group2" placeholder="Search" />
                                                <InputGroupButton>
                                                    <Button color="primary"><i className="fa fa-twitter"></i>
                                                    </Button>
                                                </InputGroupButton>
                                            </InputGroup>
                                        </Col>
                                ...
                                <Form action="" method="post">
                                    ...
                                    <FormGroup>
                                        <InputGroup>
                                            ...
                                            <InputGroupAddon><i className="fa fa-envelope"></i>
                                            </InputGroupAddon>
                                        </InputGroup>
                                    </FormGroup>
                                    <FormGroup>
                                        <InputGroup>
                                            ...
                                            <InputGroupAddon><i className="fa fa-asterisk"></i>
                                            </InputGroupAddon>
                                        </InputGroup>
                                    </FormGroup>
